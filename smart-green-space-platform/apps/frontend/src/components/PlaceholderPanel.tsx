...
const TITLES: Record<NavId, { title: string; desc: string }> = {
  ...
  depreciation: { title: "Ecosystem Depreciation", desc: "Modeling environmental value loss and ecosystem decay" },
  flood:        { title: "Flood Monitoring",      desc: "ML flood risk heatmaps & drainage" },
  trends:       { title: "Ecological Trends",     desc: "Environmental comparison & temporal analysis" },
